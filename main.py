...
def start_timer():
    ...
    # this could also be done with three case if statement using reps == 8, reps % 2 == 0 and reps % 2 != 0
    match reps:
        case 0:
            count_down(work_sec)
            reps += 1
...
label_check = Label(fg=GREEN, bg=YELLOW, highlightthickness=0, font=(FONT_NAME, 20, "bold"))
